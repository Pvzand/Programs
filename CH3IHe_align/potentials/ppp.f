...
c      grid(i,j)=pott(th,ph)
      grid(i,j)=potCH3I(0,r,th,ph)

c      write(22,*) th,ph,dreal(grid(i,j))
...
c      write(22,*) 
      ...
      if (m.lt.0) write(33,*) k,m,dreal(cilm(2,k+1,-m+1))
     .                           ,dimag(cilm(2,k+1,-m+1))
      if (m.ge.0) write(33,*) k,m,dreal(cilm(1,k+1, m+1))
     .                           ,dimag(cilm(1,k+1, m+1))
