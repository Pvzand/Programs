...
c      r=rmin+(rmax-rmin)*dble(k-1)/dble(nr-1)
c       r=5.669177966
        r=8.5372549019607842
c       r=8.503766949
c      r=11.338355931
c       r=15.117807909
c        r=22.676711863
...
!       fact=(-1)**m
       ...
       if (m.eq.0) write(52,*) (fact*dreal(cilm(1,j+1,m+1)),j=m,40)
     ...
     .  ,dreal(cilm(1,3,2))  ! 2,1
     .  ,dreal(cilm(1,3,3))  ! 2,2
     ...
     .  ,dreal(cilm(1,8,7))  ! 7,6
     .  ,dreal(cilm(1,9,1))  ! 8,0
     .  ,dreal(cilm(1,9,4))  ! 8,3
     .  ,dreal(cilm(1,10,1))   ! 9,0
     .  ,dreal(cilm(1,10,4))   ! 9,3
     .  ,dreal(cilm(1,11,1))   ! 10,0
     .  ,dreal(cilm(1,12,1))   ! 11,0
     .  ,dreal(cilm(1,13,1))   ! 12,0
     .  ,dreal(cilm(1,14,1))   ! 13,0
     .  ,dreal(cilm(1,15,1))   ! 13,0
     .  ,dreal(cilm(1,16,1))   ! 13,0
     .  ,dreal(cilm(1,17,1))   ! 13,0
     .  ,dreal(cilm(1,18,1))   ! 13,0
     .  ,dreal(cilm(1,19,1))   ! 13,0
     .  ,dreal(cilm(1,20,1))   ! 13,0
     ...
     .  ,dreal(cilm(2,8,1)),dimag(cilm(2,8,1))   ! 7,0
     .  ,dreal(cilm(2,8,4)),dimag(cilm(2,8,4))   ! 7,-3
     .  ,dreal(cilm(2,8,8)),dimag(cilm(2,8,8))   ! 7,-7
     .  ,dreal(cilm(2,9,1)),dimag(cilm(2,9,1))   ! 8,0
     .  ,dreal(cilm(2,9,4)),dimag(cilm(2,9,4))   ! 8.-3
...
c      enddo   ! end of loop over radius
