  integer, parameter :: nbrat1=1, nbrat2=10, nDIMorb0=3,nDIMorb=2*nDIMorb0,nDIMorb2 = 2*nDIMorb
  integer :: nbrat12
  integer :: ncoord1, ncoord2, ncoord12
  integer :: ncoordmom1, ncoordmom, ncoordmomcoef, nvar
  integer :: ndist22
...
!ccc 6*nbrat12+nDIMorb+1 to 6*nbrat12+2*nDIMorb : phase of the wave packet coefficients
  ...
  parameter (ncoordmomcoef=ncoordmom+nDIMorb) ! number of coords, mom., and coeff.modulus
  parameter (nvar=ncoordmom+nDIMorb2) ! total number of variables
